...
plan → implement → review → commit. **`TECHDEBT.md`** — известные,
сознательно отложенные проблемы (что не так, что уже пробовали, где
искать) — загляни туда, прежде чем чинить баг, который выглядит уже
знакомым.
