...
задача привязана к проекту, другая — к цели через ту же связь
(project_id — Phase 54: проекты и цели одна сущность, у цели теперь
такой же настоящий id, как у проекта). Не тестовые данные для отладки
— реальные примеры того, что можно делать в приложении, пользователь
сам решает, оставить их или удалить."""
